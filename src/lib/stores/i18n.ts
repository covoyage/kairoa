...
const translations = {
  en: {
    ...
    home: {
      ...
      samlDecoderDesc: 'Decode and inspect SAML responses, requests, and assertions',
      ...
      dateDiffDesc: 'Calculate the difference between two dates with business days support'
    },
    nav: {
    ...
    aiChat: {
      ...
      providerGemini: 'Google Gemini (generativelanguage.googleapis.com)',
    ...
    encodeDecode: {
      ...
      gzip: 'GZIP',
      encodeGzipPlaceholder: 'Enter text to compress with GZIP...',
      decodeGzipPlaceholder: 'Enter Base64-encoded GZIP data to decompress...',
      bech32: 'Bech32',
      encodeBech32Placeholder: 'Enter hex data to encode as Bech32 (e.g., 751e76e8f1 or bc:751e76e8f1)...',
      decodeBech32Placeholder: 'Enter Bech32 string to decode (e.g., bc1w508d6q...)',
    ...
    gitCommands: {
      ...
      searchPlaceholder: 'Search by command name...',
      showAllCommands: 'Show All',
      hideAllCommands: 'Hide All',
    ...
    samlDecoder: {
      title: 'SAML Decoder',
      input: 'SAML Input',
      placeholder: 'Paste Base64-encoded SAML response/request or raw XML...',
      inputHint: 'Supports Base64-encoded SAML (POST binding), deflate-compressed (Redirect binding), and raw XML',
      decode: 'Decode',
      summary: 'Summary',
      messageType: 'Message Type',
      version: 'Version',
      issueInstant: 'Issue Instant',
      issuerDest: 'Issuer & Destination',
      issuer: 'Issuer',
      destination: 'Destination',
      subject: 'Subject',
      nameId: 'Name ID',
      ...
      authnContext: 'Authn Context Class',
      attributes: 'Attributes',
      attributeName: 'Name',
      attributeValue: 'Value',
      formattedXml: 'Formatted XML',
      errorBase64: 'Failed to decode Base64 input',
      errorDecompress: 'Failed to decompress (DecompressionStream not available in this browser)',
      errorNotXml: 'Decompressed data is not valid XML',
      errorDecode: 'Failed to decode SAML message. Please check the input format.',
      decoding: 'Decoding...',
      validationStatus: 'Validation Status',
      timeValidity: 'Time Validity',
      timeValid: 'Valid',
      timeExpired: 'Expired',
      timeNotYetValid: 'Not Yet Valid',
      timeUnknown: 'Unknown',
      timeValidDetail: 'The assertion is within its validity period',
      expiredDetail: 'The assertion has expired (past NotOnOrAfter)',
      notYetValidDetail: 'The assertion is not yet valid (before NotBefore)',
      noConditions: 'No time conditions present in the assertion',
      signatureStatus: 'Signature Status',
      sigVerified: 'Verified',
      sigFailed: 'Verification Failed',
      sigError: 'Verification Error',
      sigChecking: 'Checking...',
      sigNotPresent: 'No Signature',
      ...
      certValidTo: 'Certificate Valid To',
      sigNotFound: 'Signature element not found in XML',
      sigNoParent: 'Signature element has no parent node',
      sigNoValue: 'No signature value found',
      sigNoDigest: 'No digest value found',
      sigNoSignedInfo: 'SignedInfo element not found',
      digestMismatch: 'Digest mismatch: the computed digest does not match the expected value',
      sigVerifyFailed: 'Signature verification failed: the signature does not match the certificate',
      certParseFailed: 'Failed to parse the X.509 certificate',
      digestMatchedNoCert: 'Digest matched but no certificate found for full verification',
      sigVerifyError: 'An error occurred during signature verification'
    },
    chmod: {
    ...
    dateDiff: {
      ...
      presetYesterday: 'Yesterday → Today',
      presetToday: 'Today',
      presetTomorrow: 'Today → Tomorrow',
      ...
      sameTime: 'Same time',
      negativePrefix: '-',
      negativeNote: 'Note: The end date is before the start date, results show absolute difference',
      selectDates: 'Please select both start and end dates to calculate the difference'
    },
    dateTimePicker: {
  ...
  zh: {
    ...
    home: {
      ...
      samlDecoderDesc: '解码和检查 SAML 响应、请求和断言',
      ...
      dateDiffDesc: '计算两个日期之间的差值，支持工作日统计'
    },
    nav: {
      hash: 'Hash 计算器',
      time: '时间转换',
    ...
    encodeDecode: {
      ...
      gzip: 'GZIP',
      encodeGzipPlaceholder: '输入要用 GZIP 压缩的文本...',
      decodeGzipPlaceholder: '输入 Base64 编码的 GZIP 数据进行解压...',
      bech32: 'Bech32',
      encodeBech32Placeholder: '输入要编码为 Bech32 的十六进制数据（如 751e76e8f1 或 bc:751e76e8f1）...',
      decodeBech32Placeholder: '输入要解码的 Bech32 字符串（如 bc1w508d6q...）',
    ...
    gitCommands: {
      ...
      showAllCommands: '显示全部',
      hideAllCommands: '隐藏全部',
      allCommands: '全部命令',
      noResults: '未找到命令',
      descriptions: {
    ...
    samlDecoder: {
      title: 'SAML 解码器',
      input: 'SAML 输入',
      placeholder: '粘贴 Base64 编码的 SAML 响应/请求或原始 XML...',
      inputHint: '支持 Base64 编码的 SAML（POST 绑定）、deflate 压缩（Redirect 绑定）和原始 XML',
      decode: '解码',
      summary: '摘要',
      messageType: '消息类型',
      version: '版本',
      ...
      attributeName: '名称',
      attributeValue: '值',
      formattedXml: '格式化 XML',
      errorBase64: 'Base64 解码失败',
      errorDecompress: '解压失败（当前浏览器不支持 DecompressionStream）',
      errorNotXml: '解压后的数据不是有效的 XML',
      errorDecode: 'SAML 消息解码失败，请检查输入格式。',
      decoding: '解码中...',
      validationStatus: '验证状态',
      timeValidity: '时间有效性',
      timeValid: '有效',
      timeExpired: '已过期',
      timeNotYetValid: '尚未生效',
      timeUnknown: '未知',
      timeValidDetail: '断言在有效期内',
      expiredDetail: '断言已过期（超过 NotOnOrAfter 时间）',
      notYetValidDetail: '断言尚未生效（未到 NotBefore 时间）',
      noConditions: '断言中未包含时间条件',
      ...
      sigChecking: '检查中...',
      sigNotPresent: '无签名',
      signatureDetails: '签名详情',
      sigAlgorithm: '签名算法',
      sigValue: '签名值',
      certSubject: '证书主体',
      certIssuer: '证书签发方',
      certSerial: '证书序列号',
      certValidFrom: '证书生效时间',
      certValidTo: '证书失效时间',
      sigNotFound: 'XML 中未找到签名元素',
      sigNoParent: '签名元素没有父节点',
      sigNoValue: '未找到签名值',
      sigNoDigest: '未找到摘要值',
      sigNoSignedInfo: '未找到 SignedInfo 元素',
      digestMismatch: '摘要不匹配：计算的摘要与预期值不一致',
      sigVerifyFailed: '签名验证失败：签名与证书不匹配',
      certParseFailed: '解析 X.509 证书失败',
      digestMatchedNoCert: '摘要匹配但未找到证书用于完整验证',
      sigVerifyError: '签名验证过程中发生错误'
    },
    chmod: {
      title: 'Chmod 权限计算器',
    ...
    dateDiff: {
      ...
      swap: '交换日期',
      quickPresets: '快速预设',
      presetYesterday: '昨天 → 今天',
      presetToday: '今天',
      presetTomorrow: '今天 → 明天',
      presetLastWeek: '上周',
      presetNextWeek: '下周',
      presetLastMonth: '上月',
      presetNextMonth: '下月',
      ...
      sameTime: '同一时间',
      negativePrefix: '-',
      negativeNote: '注意：结束日期早于开始日期，结果显示为绝对差值',
      selectDates: '请选择开始日期和结束日期以计算差值'
    },
    dateTimePicker: {
